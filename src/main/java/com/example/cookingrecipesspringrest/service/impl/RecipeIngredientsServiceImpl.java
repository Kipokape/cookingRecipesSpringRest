...
public class RecipeIngredientsServiceImpl implements RecipeIngredientsService {
    ...
    public RecipeIngredientsDTO findById(Long id) {
        Optional<RecipeIngredients> optionalRecipeIngredients = recipeIngredientsRepository.findById(id);

        RecipeIngredientsDTO recipeIngredientsDTO;
        if (optionalRecipeIngredients.isPresent()) {
            recipeIngredientsDTO = recipeIngredientsDtoMapper.toDto(optionalRecipeIngredients.get());
        } else {
