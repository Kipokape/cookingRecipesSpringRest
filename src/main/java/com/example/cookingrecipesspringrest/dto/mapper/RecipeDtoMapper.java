...
public interface RecipeDtoMapper {
    ...
    @Named("toIngredientsWithoutIngredientsDto")
    @InheritInverseConfiguration(name = "toDtoWithoutIngredients")
    Recipe toIngredientsWithoutIngredientsDto(RecipeDTO dto);
